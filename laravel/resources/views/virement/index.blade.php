...
<div class="modal fade" id="addEmployeeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <div class="form-group">
         ...
         <label for="cNom_client" style="color:blue">Compte ID Destinataire</label>
         <input type="text" name='compte_destinataire' class="form-control" style='color:blue'>
    </div>
      ...
      <div class="col-lg-12">
        <div class="card shadow position" id="pos">
          <div class="card-header  d-flex justify-content-between align-items-center bg-b">
            <h3 class="text-light ">Gestion des virements</h3>
            <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addEmployeeModal"><i
                class="bi-plus-circle me-2"></i>Nouveau virement</button>
          </div>
          <div>
